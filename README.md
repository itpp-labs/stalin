...
* далее следуйте инструкциям по обновлению сайта (в частности, инструкция по обновлению сайта после изменений в папке hugo/ -- см ниже "Памятка Администраторам")
* для обновления индекса нужно запустить команду ``make upload_search``
